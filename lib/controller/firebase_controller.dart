...
class FirebaseController {
    ...
    try {
      await FirebaseFirestore.instance
        ...
        if (documentSnapshot.exists) {
          if (documentSnapshot['accountType'] == 'CLIENT') isClient = AccountType.CLIENT; //Changed from account_type to accountType -Caitlyn
        }
      });
    } catch (e) {
      print(e);
  ...
  static Future<Profile> getProfile(String uid) async {
    var result = await FirebaseFirestore.instance.collection('accounts').doc(uid).get();
